...
ingest_xlsm_filename = os.path.join('Data', 'calibration_ingest_form-SouthAfrica.xlsm')
...
config_templates = []
config_filename = os.path.join(template_files_dir, 'config_new.json')
...
demographics_filenames = [
    os.path.join(static_files_dir, 'SSA_Demographics_With_Properties.json'),
...
def map_sample_to_model_input(sample_dict, template_set_name, scenario_name, campaign_filename, random_run_number=True):
    ...
    for province in province_names+['All']:
